...
<div id="header">
<h1><center>Return Books!</center></h1>
</div>
...
<table border="0">
<tr>
  <td>Input the Card ID:</td>
  <td><input type="text" name="id"></td>
</tr>
</table>

<input type = "submit" name="sub" class = "btn" value="Check This Card!"onmouseover="this.style.backgroundPosition='left -36px'"
