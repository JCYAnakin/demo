...
<div id="header">
<h1><center>Manage Cards!</center></h1>
</div>
<div id="menu">
<ul>
<br>
...
<br>
<br>
  <li  align="center"><a href = 'card_add.php'class = "a"> Add a Card! </a></li>
  <br>
  <br>
   <br>
  <br>
  <li align = "center"><a href = 'card_del.php'class = "a" >Del a Card!</a></li>
    <br>
  <br>
   <br>
  <br>
  <li align = "center"><a href = 'index.php'class = "a" >Return Home!</a></li>
</ul>
</center></h2>
</div>
